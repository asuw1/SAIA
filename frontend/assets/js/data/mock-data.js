...
const regulatoryFrameworks = {
    NCA:  { name: 'National Cybersecurity Authority',      clauses: ['NCA-ACC-4.2.1', 'NCA-NET-6.2.3', 'NCA-DAT-3.2.4'] },
    SAMA: { name: 'Saudi Arabian Monetary Authority',      clauses: ['SAMA-ENC-3.1.5', 'SAMA-ACC-1.4.2'] },
    CST:  { name: 'Communications and Space Technology',   clauses: ['CST-LOG-2.3.2', 'CST-SEC-4.5.1'] },
    IA:   { name: 'Internal Audit',                        clauses: ['IA-AUD-5.1.1'] }
};

// Workflow: Use Case 1 — Review Audit Report
...
// Workflow: Use Case 2 — Manage Rules
...
// Workflow: Use Case 3 — Handle Alerts
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = { mockAlerts, kpiData, severityData, confusionMatrixData, regulatoryFrameworks, workflowUseCase1, workflowUseCase2, workflowUseCase3 };
}
